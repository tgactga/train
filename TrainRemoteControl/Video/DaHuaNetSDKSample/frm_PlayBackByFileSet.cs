...
namespace DaHuaNetSDKSample
{
    public partial class frm_PlayBackByFileSet : Form
    {
        ...
        /// 提示消息标题
        /// </summary>
        private const string strMsgTitle = "大华网络SDK Demo程序";
        ...
        private void btnQuery_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("请输入通道号!", strMsgTitle);
                return;
            }
            else
            {
            ...
            {
                MessageBox.Show("请输入设备名!", strMsgTitle);
                return;
            }
            if (cmbChannelSelect.SelectedIndex == -1)
            {
                MessageBox.Show("请选择文件类型!", strMsgTitle);
                return;
            }
            else
            {
            ...
            {
                MessageBox.Show("开始日期不在结束日期前!", strMsgTitle);
                return;
            }
