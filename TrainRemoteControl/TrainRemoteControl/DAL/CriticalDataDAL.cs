...
namespace TrainRemoteControl
{
    public class CriticalDataDAL
    {
        ...
        public bool SaveCriticalData(CriticalData cd)
        {
            ...
            sqlParams[0] = new SQLiteParameter(PARAM_LCNUM, DbType.String, 20);
            sqlParams[1] = new SQLiteParameter(PARAM_GID, DbType.Int32, 4);
            sqlParams[2] = new SQLiteParameter(PARAM_OILPRESS, DbType.String, 20);
            sqlParams[3] = new SQLiteParameter(PARAM_WATERTEMP, DbType.String, 20);
            sqlParams[4] = new SQLiteParameter(PARAM_FRE, DbType.String, 20);
            sqlParams[5] = new SQLiteParameter(PARAM_MSPEED, DbType.String, 20);
            sqlParams[6] = new SQLiteParameter(PARAM_V, DbType.String, 20);
            sqlParams[7] = new SQLiteParameter(PARAM_CURRENT, DbType.String, 20);
            sqlParams[8] = new SQLiteParameter(PARAM_MPOWER, DbType.String, 20);
            sqlParams[9] = new SQLiteParameter(PARAM_POWERFACTOR, DbType.String, 20);
            sqlParams[10] = new SQLiteParameter(PARAM_OILMASS, DbType.String, 20);
            sqlParams[11] = new SQLiteParameter(PARAM_ALARMVALUE, DbType.Int32, 4);
            sqlParams[12] = new SQLiteParameter(PARAM_DATETIME, DbType.DateTime, 8);
